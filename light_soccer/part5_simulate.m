...
function  [x_sim,u_feedback,calc_time] = part5_simulate( N,figureName )
    ...
    title('input keeper in fucntion of time');
    legend('F_x','F_y','m');
    xlabel('t(s)');ylabel('u');

    if(~strcmp(figureName,'NOSAVE'))
        saveas(fig,['./report/img/MPC/' figureName '_traj_input.png']);
    end
